...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item {{ $ii==0?'active':'' }}">
            <img src="{{ asset('noticias/images.jpeg') }}"  class="d-block w-100" alt="..." width="15">
...
<div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
    <div class="col-md-6 px-0">
      ...
      <p class="lead mb-0"><a href="#" class="text-white fw-bold">Leer mas...</a></p>
    </div>
</div>
    ...
    @foreach ($dosn as $dn)
        <div class="col-md-6">
            ...
            <div class="col p-4 d-flex flex-column position-static">
                <strong class="d-inline-block mb-2 text-primary">{{ $dn->tipo->nombre }}</strong>
                <h3 class="mb-0">
                    {{ $dn->titulo }}
                </h3>
            ...
            <div class="col-auto d-none d-lg-block">
                ...
                @if ($dn->foto)
                    <img class="bd-placeholder-img" src="{{ asset($dn->foto) }}" width="200" height="250" alt="">
                @else
  ...
  <div class="row g-5">
    ...
    <div class="col-md-8">
      @foreach (App\Models\Archivo::get() as $ar)
          
          
          @php
              $tipo = Str::of($ar->direccion)->explode('.');
          @endphp

           @if ($tipo[1]==='pdf')
           <a class="btn btn-primary btn-sm" href="{{ Storage::url($ar->direccion) }}">{{ $tipo[1] }}</a>
            @else    
          <img width="45" src="{{ Storage::url($ar->direccion) }}" alt="">
           @endif
